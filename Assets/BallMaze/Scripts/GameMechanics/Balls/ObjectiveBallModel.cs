...
{
    [Serializable]
    public class ObjectiveBallModel : BallModel
    {
        private enum State
        {
            IDLE,
        ...
        private ObjectiveBallView view;
        ...
        {
            view = gameObject.GetComponent<ObjectiveBallView>();
        ...
        public override void FillObjective()
        {
            ...
            fusionned = true;
            view.FillAnimation(boardModel.GetTile(posX, posY));
        }

        public override void UnFillObjective()
        {
            boardModel.AddBrick(this, posX, posY);
            view.ComingBackAnimation(boardModel.GetTile(posX, posY));
            fusionned = false;
        }
        ...
        private GameObject GetCorrespondingTile()
        {
            ...
            {
                if (tile.GetComponent<TileModel>().GetObjectiveType() == GetObjectiveType())
                {
                    return tile;
                }
            }
