...
namespace GenericStateMachine
{
     ...
     **/
    internal class Transition<StateMachineType, EventType, EventSubType> : Transition<StateMachineType, EventType> where StateMachineType : StateMachine<StateMachineType, EventType> where EventSubType : EventType
    {
