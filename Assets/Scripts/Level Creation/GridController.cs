...
public class GridController : MonoBehaviour
{
    ...
    private void CreateTiles()
    {
        for (int i = 0; i < gridSize.x; i++)
        {
            ...
            {
                GameObject tile = Instantiate(emptyTile, new Vector3((i - gridSize.x / 2.0f) * Board.BASE_TILE_SIZE_X, 0, (j - gridSize.y / 2.0f) * Board.BASE_TILE_SIZE_Y), Quaternion.identity);
