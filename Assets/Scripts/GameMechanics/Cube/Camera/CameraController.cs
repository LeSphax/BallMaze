...
public delegate void NewRotationHandler(Vector3 newRotation);
...
public class CameraController : MonoBehaviour
{
    ...
    public event NewRotationHandler SliceChanged;
    public event EmptyEventHandler RotationChanged;
    ...
    public void SendSliceChangedEvent()
    {
        if (SliceChanged != null)
            SliceChanged.Invoke((Referent.transform.localRotation * Quaternion.Euler(targetRotation)).eulerAngles);
    }
